...
genelist <- read.table("./data/GSE65174/genes_of_interest_nov17.txt")[[1]]
...
write.xlsx(final_genelist, file = "./analysis/differential_expression/output/de_genes_mouse_liver_network_nov17.xlsx", rowNames = TRUE, colNames = TRUE)
